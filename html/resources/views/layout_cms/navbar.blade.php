        ...
        <div class="row clearfix">
            <div class="col-12">
                <div class="navbar-logo">
                    ...
                    <a class="navbar-brand" href="#"><img src="{{ asset('/img/logo.svg') }}" width="30" alt="MEJ"><span class="m-l-10">Saladitas</span></a>
                </div>
                <ul class="nav navbar-nav">
                                ...
                                <ul class="menu list-unstyled">
                                    <li>
                                        <a href="javascript:void(0);">
                                            <div class="media">
                                                <img class="media-object" src="{{ asset('cms_front/images/avatar5.jpg') }}" alt="">
                    ...
                    <li class="dropdown profile">
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button">
                            <img class="rounded-circle" src="{{ asset('cms_front/images/profile_av.jpg') }}" alt="User">
                        </a>
                        {{-- <ul class="dropdown-menu">
                            <li>
                                <div class="user-info">
