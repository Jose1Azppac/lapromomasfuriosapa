...
@section('title') Ranking diario | La promo más furiosa @endsection
    ...
    <section class="ranking">
        <div class="container">
            ...
            <div class="c__cta btn__rank scrll">
                <div>
                    <a href="{{route('ranking-diario')}}" class="cta cta01"><span>Diario</span></a>
                    <a href="{{route('ranking-semanal')}}" class="cta cta02"><span>Semanal</span></a>
                    <a href="{{route('ranking-quincenal')}}" class="cta cta02"><span>Quincenal</span></a>
                </div>
            </div>
            <div class="cont__tab">
                <table>
