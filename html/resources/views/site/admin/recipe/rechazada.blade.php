...
@section('parentPageTitle', 'Recetas tickets rechazadas')
@section('title', 'Recetas tickets rechazadas')
...
<script type="text/javascript">
    ...
    function showConfirmMessage( userId ) {
        swal({
            title: "ALERTA",
            text: "¿Estas seguro de restaurar la receta?",
            type: "warning",
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                $.ajax({
                    url: "{{route('recetasrechazadas.restorerecipe')}}",
                    method:'POST',
                    dataType: "json",
                    data: formData,
                    success: function (data) {
                        swal("¡Restaurada!", "La receta ha sido restaurada para seguir participando.", "success");
                ...
                swal("¡Cancelado!", "La receta sigue rechazada", "error");
            }
        });
    }
    ...
    $(function () {
        ...
        var table = $('.yajra-datatable').DataTable({
            ...
            ajax: "{{ route('recetasrechazadas.index') }}",
            order: [ [0, 'desc'] ],
            columns: [
                {data: 'id', name: 'id'},
                {data: 'title_recipe', name: 'title_recipe'},
