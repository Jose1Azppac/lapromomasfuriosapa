...
@section('parentPageTitle', 'tickets del usuarioooo')
@section('title', 'tickets del usuarioooo')
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var table = $('.yajra-datatable').DataTable({
            ...
            ajax: "{{ route('participantes.show',$id_user) }}",
            order: [ [0, 'desc'] ],
            columns: [
                {data: 'id_lote', name: 'id_lote'},
                {data: 'name', name: 'name'},
                {data: 'fecha_alta_lote', name: 'fecha_alta_lote'},
