...
@section('parentPageTitle', 'Editar Concurso diario')
@section('title', 'Editar Concurso diario')

@section('content')

<div class="row clearfix"><!-- Evento -->
    <div class="col-lg-12 col-md-12 col-sm-12">
        <form id="form_create_event" method="put" enctype="multipart/form-data">
        @csrf
            <div class="card">
                <div class="header">
                    <h2><strong>Fecha Inicio</strong></h2>
                </div>
                <div class="body">
                    <div class="row clearfix">                           
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input type="date" id="event_start_datetime"  name="event_start_datetime" class="form-control" placeholder="Click para desplegar el calendario" value="{{$semana->inicio}}">
                                <input type="hidden" name="id_fecha" id="id_fecha" value="{{$semana->id}}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="header">
                    <h2><strong>Fecha Final</strong></h2>
                </div>
                <div class="body">
                    <div class="row clearfix">                           
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input type="date" id="event_end_datetime"  name="event_end_datetime" class="form-control" placeholder="Click para desplegar el calendario" value="{{$semana->final}}">
...
<script>
    $(document).ready(function(){
        ...
        $("#SubmitConcurso").click(function(e) {
            ...
            $.ajax({
                url: "{{route('cms.SaveWeekEditByParticipation')}}",
                method:'POST',
                dataType: "json",
                data: {
